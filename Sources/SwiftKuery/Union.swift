...
/// The SQL SELECT UNION/UNION ALL statement.
public enum Union: Buildable {
    ...
    public func build(queryBuilder: QueryBuilder) throws -> String {
        switch self {
        case .union(let query):
            return try " UNION " + query.build(queryBuilder: queryBuilder)
        case .unionAll(let query):
            return try " UNION ALL " + query.build(queryBuilder: queryBuilder)
        }
    }
}
