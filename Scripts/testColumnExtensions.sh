...
INPUT_LIKE_FILE="${PKG_DIR}/Scripts/TestColumnExtensionsLike.txt"
INPUT_BETWEEN_FILE="${PKG_DIR}/Scripts/TestColumnExtensionsBetween.txt"
OUTPUT_FILE="${PKG_DIR}/Tests/SwiftKueryTests/TestColumnExtensions.swift"
